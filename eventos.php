    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="home.php">Beach Sound</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="home.php">Equipe</a>
                    </li>      
                     <li>
                        <a class="page-scroll" href="home.php">Contato</a>
                    </li>
                    <li>
                     <?php 
                                    session_start();
...
?>
    ...
    echo "                            <li>Data: ".$formato."</li><li>Horário: ".$dados['hr_evento']."</li>";
