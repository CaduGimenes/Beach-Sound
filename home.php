...
<body id="page-top" class="index">
    ...
    $banco = mysqli_select_db($link, "db_TCC")
        or die ("Erro ao abrir o banco de dados: ". mysql_error());
                                     ...
                                     $sql = mysqli_query($link ,"SELECT nm_imagem FROM tb_usuario WHERE nm_email = '".$_SESSION['login']."';");
    ...
    $banco = mysqli_select_db($link, "db_TCC")
        or die ("Erro ao abrir o banco de dados: ". mysql_error());
                            ...
                            if ($_SESSION['login']) {
                                ...
                                $nome = mysqli_query($link ,"SELECT nm_usuario FROM tb_usuario WHERE nm_email = '".$_SESSION['login']."';");


                                while($array = mysqli_fetch_array($nome)){

                                 echo "<strong><center>".$array['nm_usuario']."</center><strong/>";
                                }
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <a href="eventos.php" class="page-scroll btn btn-xl">Fale mais</a>
            </div>
        </div>
    </header>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                               ...
                               <p>
                                    Venda de Ingressos: <a href="http://www.ingressonanet.com/evento/84/BIQUINI-CAVAD%C3%83O">Pela internet e em pontos de venda</a>&nbsp  Classificação : <strong>+18</strong> </p>
                                <ul class="list-inline">
