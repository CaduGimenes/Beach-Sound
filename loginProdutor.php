    ...
    $banco = mysqli_select_db($link, "db_TCC")
        ...
        if (isset($_POST['login'], $_POST['senhalogin'])) {
              ...
              $login = $_POST['login'];
                ...
                $get = mysqli_query($link, "SELECT * FROM tb_produtor WHERE nm_email = '$login' AND cd_senha = '$lsenha'");
                ...
                if ($num == 1) {
                   ...
                   header("Location: $index");
                    ...
                    while ($percorrer = mysqli_fetch_array($get)) {
                            ...
                            print '<script type="text/javascrip">window.location = "indexProd.php";</script>';
                    ...
                    <form name="sentMessage" id="contactForm" novalidate>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Telefone *" id="tel" name="tel" required data-validation-required-message="Por favor insira seu telefone." maxlength="8">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-12 text-center">
                                ...
                                <ul class="list-inline quicklinks">
                                    <li>
                                        <a href="login.php">Sou um cliente.</a>
                                    </li>
                                    <li>
...
$valida = mysqli_query($link, "SELECT * FROM tb_produtor WHERE nm_email = '$email'");
...
if ($valida == $email) {
    ...
    if (isset($_FILES['arquivo'])) {
        ...
        $inserir = mysqli_query($link, "INSERT INTO tb_produtor(nm_produtor,nm_email,cd_senha,nm_telefone,nm_imagem) VALUES('$usuario','$email','$senha','$tel','$novo_nome');");
    }
